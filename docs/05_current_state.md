...
- `CombatService` - меч-`Tool`, серверный hitbox, враги с HP, тренировочный манекен, враждебный лагерь, захват территории, маркер и постройка аванпоста, восстановление захвата по профилю, спасённый NPC и его вербовка в лагерь (поле `JoinedNPCs`).
...
это фундамент будущих NPC-работников: пока без пассивного дохода, автоматизации и
профессий. Следующий шаг развития — Фаза 2.2 (перенос присоединившегося NPC к аванпосту
игрока как первого работника лагеря), см. `docs/planning/05_next_codex_task.md` и мастер-план
