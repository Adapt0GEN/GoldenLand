...
MVP 0.4.0-step-4 завершен. Forge production loop is now documented as verified. The next small gameplay step is to make `MetalParts` useful by upgrading the Forge from level 1 to level 2.
